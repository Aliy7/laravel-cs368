...
{{-- 
                     @if($post->image_path)
                    <img src="{{ asset($post->image_path) }}" alt="Post Image" style="max-width:100%; height:auto;">
                @endif 
             --}}
             ...
             <div>
                ...
                @if($post->image_url)
                <img src="{{ Storage::url($post->image_url) }}" alt="Post Image" style="max-width:100%; height:auto;">
            @endif
                <!-- More content -->
            </div>
