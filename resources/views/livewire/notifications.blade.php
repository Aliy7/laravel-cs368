            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                @else
                    @foreach ($userNotification as $notification)
                        ...
                        @endphp
                            {{-- @php
                            $like = \App\Models\Like::find($notification->c);
                        @endphp --}}
                        ...
                        <div class="bg-gray-100 dark:bg-gray-700 p-4 rounded-lg mt-4 shadow">
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <div>
                                    <strong class="font-semibold text-blue-500 text-right"> {{ $comment->user->username}}</strong>
                                    <span class=" font-semibold text-right "><i>replied on your post </i></span>
                                </div>
                            </div>
